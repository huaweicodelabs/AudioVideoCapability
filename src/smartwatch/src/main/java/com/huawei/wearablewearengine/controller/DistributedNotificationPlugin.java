...
public class DistributedNotificationPlugin {
    ...
    private static final String NOTIFICATION_KEY_THUMBNAIL = "notification_key_thumbnail";
    private static final String NOTIFICATION_KEY_TITLE = "notification_key_title";
    private static final String NOTIFICATION_KEY_SINGER = "notification_key_singer";
    private static final String NOTIFICATION_KEY_MODE = "notification_key_mode";
    ...
    private static final String NOTIFICATION_KEY_ERROR_MSG = "notification_key_error_msg";
        ...
        commonEventSubscriber = new CommonEventSubscriber(commonEventSubscribeInfo) {
            ...
            public void onReceiveEvent(CommonEventData commonEventData) {
                ...
                if (receivedAction.equals(NOTIFICATION_ACTION)) {
                    ...
                    String notificaionContentThumbnail = intent.getStringParam(NOTIFICATION_KEY_THUMBNAIL);
                    String notificaionContentTitle = intent.getStringParam(NOTIFICATION_KEY_TITLE);
                    String notificaionContentSinger = intent.getStringParam(NOTIFICATION_KEY_SINGER);
                    String notificaionContentMode = intent.getStringParam(NOTIFICATION_KEY_MODE);
                    String notificaionContentStatus = intent.getStringParam(NOTIFICATION_KEY_STATUS);
                    String notificaionContentErrorMsg = intent.getStringParam(NOTIFICATION_KEY_ERROR_MSG);
                    int notificaionContentPosition = intent.getIntParam(NOTIFICATION_KEY_SONG_POSITION, 0);
                    if (eventListener != null) {
                        eventListener.onEventReceive(notificaionContent, notificaionContentThumbnail, notificaionContentTitle, notificaionContentMode, notificaionContentStatus, notificaionContentSinger, notificaionContentErrorMsg, notificaionContentPosition);
                    }
                }
            }
        };
    ...
    public void publishEvent(String event, String imageURL, String songName, String mode, String status, String singerName, String errorMsg, int position) {
        ...
        intent.setParam(NOTIFICATION_KEY_THUMBNAIL,imageURL);
        intent.setParam(NOTIFICATION_KEY_TITLE,songName);
        intent.setParam(NOTIFICATION_KEY_SINGER,singerName);
        intent.setParam(NOTIFICATION_KEY_MODE,mode);
        intent.setParam(NOTIFICATION_KEY_STATUS,status);
        intent.setParam(NOTIFICATION_KEY_ERROR_MSG,errorMsg);
    ...
    public interface DistributedNotificationEventListener {
        ...
        void onEventReceive(String result, String imageURL, String songName, String mode, String status, String singerName, String errorMsg, int position);
    }
